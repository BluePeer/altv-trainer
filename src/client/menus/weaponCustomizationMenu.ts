...
export class WeaponCustomizationMenu extends AbstractSubMenu {
    ...
    constructor(parentMenu: AbstractMenu, title: string) {
        ...
        this.menuObject.MenuOpen.on(() => {
            ...
            let description = game.getFilenameForAudioConversation(weapon.description)
            this.weaponInfo.Text = game.getFilenameForAudioConversation(weapon.name)
            ...
            WeaponCustomizationMenu.componentCollection.components[weaponHash]?.forEach(component => {
                let item = new ui.UIMenuItem(game.getFilenameForAudioConversation(component.name), game.getFilenameForAudioConversation(component.description) == "NULL" ? "" : game.getFilenameForAudioConversation(component.description))
